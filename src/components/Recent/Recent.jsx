...
const Recent = () => {
  ...
  return (
   ...
   <section data-bs-version="5.1" className="features03 cid-uXQ7jkdhDS" id="news-1-uXQ7jkdhDS">
     ...
     <div class="row">
       <div className="item features-image  col-md-6 col-lg-3 active">
       ...
       <div className="item features-image  col-md-6 col-lg-3">
         <div className="item-wrapper">
           <div className="item-img mb-3">
