  ...
  return (
    <div>
        <section data-bs-version="5.1" className="header18 cid-uXQ7jkdsIQ mbr-fullscreen" id="video-5-uXQ7jkdsIQ">
            <div className="mbr-background-video-preview" style={{display: 'block', backgroundSize: 'cover', backgroundPosition: 'center center', backgroundImage: 'url("/src/assets/images/portada.png")'}}>
            </div>
